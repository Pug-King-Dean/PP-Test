...
namespace PartyPlaza
{
    public partial class frmAddSupplier : Form
    {
        ...
        private void btnAddAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                mySupplier.IDNO = Convert.ToInt32(lblAddCustNo.Text.Trim());
            ...
            try
            {
                if (ok)
                {
                    ...
                    drSupplier["CustomerNo"] = mySupplier.IDNO;
        ...
        private void getNumber(int noRows)
        {
            ...
            lblAddCustNo.Text = (int.Parse(drSupplier["SupplierNo"].ToString() + 1).ToString());
        }
    }
}
